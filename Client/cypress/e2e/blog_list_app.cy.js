describe('Blog app', function() {
  ...
  describe('When logged in', function() {
    ...
    it('A blog can be created', function() {
      ...
      cy.get('.visible-content').should('contain', 'Hala Madrid Karim')
    })
    ...
    it('The user who created a blog can delete it', function() {
      ...
      cy.contains('Real Madrid Madrid').parent().find('.view-button').click()
      cy.contains('Real Madrid Madrid').parent().find('.remove-button').click()
    })
    ...
    it('The blogs are ordered according to likes', function () {
      ...
      cy.contains('Real Madrid Campeon Vini').parent().find('.view-button').click()
      cy.contains('Real Madrid Campeon Vini').parent().find('.like-button').click()
      cy.wait(2000)
      cy.contains('Real Madrid Campeon Vini').parent().find('.like-button').click()
      cy.contains('River Campeon Ortega').parent().find('.view-button').click()
      cy.contains('River Campeon Ortega').parent().find('.like-button').click()
